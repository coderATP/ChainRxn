...
export class TutorialScene extends BaseScene{
    ...
    handleGamePause(){
        ...
        this.ui.tutorial_backBtn.addEventListener('click', ()=>{
            if(this.tutorialMode){
                PlayScene.watch.resumeWatch(PlayScene.gameplayUI.timeIcon.label);
                this.scene.stop();
    ...
    addTutorials(){
        ...
        this.ui.tutorial_section11Paragraph.innerText = tutorial.section_11;
        this.ui.tutorial_section12Paragraph.innerText = tutorial.section_12;
        this.ui.tutorial_section13Paragraph.innerText = tutorial.section_13;
        this.ui.tutorial_section14Paragraph.innerText = tutorial.section_14;
